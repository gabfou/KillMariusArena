...
public class GamePref {
    ...
    public KeyCode _attack1 = KeyCode.RightControl;
    ...
    public KeyCode _dash1 = KeyCode.RightShift;
    ...
    public void init()
    {
        _attack1 = (KeyCode)PlayerPrefs.GetInt("attack1", (int)KeyCode.RightControl);
        ...
        dash1 = (KeyCode)PlayerPrefs.GetInt("dash1", (int)KeyCode.RightShift);
